...
def create_gif(model_path, image_path, save_path, theta=-0.15, phi=-0.1, tx=0, ty=0, tz=0.1, num_frames=5):
...
if __name__ == '__main__':
    create_gif('./synsin/modelcheckpoints/realestate/zbufferpts.pth', 'apartment.JPG', 'test_gif.gif')